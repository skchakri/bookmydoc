# BookMyDoc Android App (Hotwire Native)

This is the native Android application for BookMyDoc healthcare platform, built using Hotwire Native (Turbo Native).
...
keytool -genkey -v -keystore bookmydoc-release-key.keystore \
  -alias bookmydoc -keyalg RSA -keysize 2048 -validity 10000
```
...
Copyright © 2024 BookMyDoc. All rights reserved.

## Support

For issues and questions:
- Email: support@bookmydoc.app
